...
# Set computer name, host name and local host name
...
# Use notification instead of the dialog box for crash reports
...
# .DS_Store files are needed to store extended metatada such as tags and comments
